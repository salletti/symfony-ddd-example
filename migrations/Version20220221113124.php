 ...
 */
final class Version20220221113124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD article_id UUID DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ALTER id TYPE UUID');
        $this->addSql('ALTER TABLE comment ALTER id DROP DEFAULT');
        $this->addSql('COMMENT ON COLUMN comment.article_id_id IS \'(DC2Type:comment_id)\'');
