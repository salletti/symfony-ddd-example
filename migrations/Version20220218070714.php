 ...
 */
final class Version20220218070714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id UUID NOT NULL, message TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, article_id UUID NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
